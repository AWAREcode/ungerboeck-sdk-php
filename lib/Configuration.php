...
class Configuration
{
     ...
     * @var string[]
     */
    protected $apiKeyPrefixes = ['Token' => ''];
     ...
     * @var string
     */
    protected $host = 'https://fomf.ungerboeck.com/TEST';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/20.94.1.1/php';
    ...
    {
        $report  = 'PHP SDK (FomF\Ungerboeck\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: v1' . PHP_EOL;
        $report .= '    SDK Package Version: 20.94.1.1' . PHP_EOL;
