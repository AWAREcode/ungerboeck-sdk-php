...
class ServiceOrdersApi
{
    ...
    /**
     * Operation serviceOrdersGetServiceOrderList
     *
     ...
     * @return \FomF\Ungerboeck\Client\Model\ServiceOrdersModel
     */
    public function serviceOrdersGetServiceOrderList($org_code, $search)
    {
        list($response) = $this->serviceOrdersGetServiceOrderListWithHttpInfo($org_code, $search);
        return $response;
    }

    /**
     * Operation serviceOrdersGetServiceOrderListWithHttpInfo
     *
     * Standard - Search for Service orders using OData.  Note, this will not return user fields.  Use the single GET endpoint to retrieve user fields.
     *
     * @param  string $org_code The organization code in which the search will take place (required)
     ...
     * @return array of \FomF\Ungerboeck\Client\Model\ServiceOrdersModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceOrdersGetServiceOrderListWithHttpInfo($org_code, $search)
    {
        $returnType = '\FomF\Ungerboeck\Client\Model\ServiceOrdersModel';
        $request = $this->serviceOrdersGetServiceOrderListRequest($org_code, $search);
    ...
    /**
     * Operation serviceOrdersGetServiceOrderListAsync
     *
     * Standard - Search for Service orders using OData.  Note, this will not return user fields.  Use the single GET endpoint to retrieve user fields.
     *
     * @param  string $org_code The organization code in which the search will take place (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceOrdersGetServiceOrderListAsync($org_code, $search)
    {
        return $this->serviceOrdersGetServiceOrderListAsyncWithHttpInfo($org_code, $search)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation serviceOrdersGetServiceOrderListAsyncWithHttpInfo
     *
     * Standard - Search for Service orders using OData.  Note, this will not return user fields.  Use the single GET endpoint to retrieve user fields.
     *
     * @param  string $org_code The organization code in which the search will take place (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceOrdersGetServiceOrderListAsyncWithHttpInfo($org_code, $search)
    {
        $returnType = '\FomF\Ungerboeck\Client\Model\ServiceOrdersModel';
        $request = $this->serviceOrdersGetServiceOrderListRequest($org_code, $search);
    ...
    /**
     * Create request for operation 'serviceOrdersGetServiceOrderList'
     *
     * @param  string $org_code The organization code in which the search will take place (required)
     * @param  string $search &lt;a href&#x3D;\&quot;https://supportcenter.ungerboeck.com/hc/en-us/articles/115010610608-Searching-Using-the-API\&quot;&gt;How to make an Ungerboeck API search&lt;/a&gt; (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function serviceOrdersGetServiceOrderListRequest($org_code, $search)
    {
        // verify the required parameter 'org_code' is set
        if ($org_code === null || (is_array($org_code) && count($org_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_code when calling serviceOrdersGetServiceOrderList'
            );
        }
        // verify the required parameter 'search' is set
        if ($search === null || (is_array($search) && count($search) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $search when calling serviceOrdersGetServiceOrderList'
            );
        }
    ...
    {
        $this->serviceOrdersMoveOrderWithHttpInfo($data);
    }
