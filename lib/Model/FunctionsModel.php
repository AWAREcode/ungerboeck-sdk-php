...
class FunctionsModel implements ModelInterface, ArrayAccess
{
     ...
     * Sets requirements
     *
     * @param string $requirements <div class=\"tooltip\">Info<span class=\"tooltiptext\"><span class=\"tooltipHeader\">API Help:</span> This will contain a comma delimited list of requirement codes (EV712_FUNC_REQUIREMENTS). To search you can only do one code at a time (Ex. Requirements eq 'REQ').  <div class=\"TooltipSpace\"></div>  <span class=\"tooltipHeader\">Database column:</span> cREQUIREMENT  <div class=\"TooltipSpace\"></div>  <span class=\"tooltipHeader\">Read Only</span>  <div class=\"TooltipSpace\"></div>  <span class=\"tooltipHeader\">Searchable</span></span></div>
     *
     * @return $this
     */
